...
import static com.fusion.javaquiz.Model.setTest;
...
import com.fusion.javaquiz.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownTimer = new CountDownTimer(1500, 1000) { // 15 seconds with 1-second intervals
            @Override
            public void onTick(long millisUntilFinished) {
                int secondsLeft = (int) (millisUntilFinished / 1000);
                binding.linearProgressBar.setProgress(15000 - (int) millisUntilFinished);
            }
